function pagina(){
    ...
    novaTarefa.setAttribute("data-tarefa", texto.toLowerCase()); //adiciona atributos personalizados
    ...
    novaTarefa.addEventListener("click", () => {
        ...
        novaTarefa.classList.add("removido"); //acrescenta a class html removido
